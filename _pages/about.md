...
## News
- 2023.03: **[Award]** Received ICLR'23 travel award. Thanks to [ICLR](https://iclr.cc/)! I am going to attend ICLR'23 in [Kigali Rwanda](https://www.wikiwand.com/en/Kigali) to present our papers ([Trainability Preserving Neural Pruning](https://openreview.net/forum?id=AZFvpnnewr), [Image as Set of Points](https://openreview.net/forum?id=awnvqZja69)). See you there if you also attend :-)
...
- 2023.01: **[Preprint]** 🔥Check out our preprint work that deciphers the *so confusing* benchmark situation in neural network (filter) pruning: [[Arxiv](https://arxiv.org/abs/2301.05219)] [[Code](https://github.com/mingsun-tse/why-the-state-of-pruning-so-confusing)] (to release)
- 2022.12: **[Preprint]** 🔥Check out our new blazing fast🚀 neural rendering model on mobile devices: MobileR2L can render **1008x756** images at **56fps** on **iPhone13** [[Arxiv](https://arxiv.org/abs/2212.08057)] [[Code](https://github.com/snap-research/MobileR2L)] -- This paper is accpeted by CVPR'23!
- 2022.12: Recognized among [2022 Snap Fellowship Honorable Mentions](https://research.snap.com/fellowships.html). Thanks to Snap!
- 2022.10: **[Award]** Awarded the NeurIPS'22 Scholar Award. Thanks to <a href="https://nips.cc/">NeurIPS</a>!
...
- 2021.06: **[Internship]** Start summer internship at Snap Inc., working with the fantastic <a href="https://research.snap.com/team/category/creative-vision.html">Creative Vision</a> team.
...
<tr style="border-collapse: separate; border-spacing:none;">
  ...
  <td style="border-collapse: collapse; border: none;">
    ...
    "<i>What Makes a "Good" Data Augmentation in Knowledge Distillation -- A Statistical Perspective</i>".<br>
...
<tr style="border-collapse: separate; border-spacing:none;">
  ...
  <td style="border-collapse: collapse; border: none;">
    ...
    "<i>Parameter-Efficient Masking Networks</i>".<br>
    In <b>NeurIPS</b>, 2022.<br>
    <img src="https://raw.githubusercontent.com/mingsun-tse/mingsun-tse.github.io/master/images/pdf_icon.png" width="20" height="20" hspace="5">
...
<tr style="border-collapse: separate; border-spacing:none;">
  ...
  <td style="border-collapse: collapse; border: none;">
    ...
    "<i>Look More but Care Less in Video Recognition</i>".<br>
    In <b>NeurIPS</b>, 2022.<br>
    <img src="https://raw.githubusercontent.com/mingsun-tse/mingsun-tse.github.io/master/images/pdf_icon.png" width="20" height="20" hspace="5">
...
<tr style="border-collapse: separate; border-spacing:none;">
  ...
  <td style="border-collapse: collapse; border: none;">
    ...
    "<i>R2L: Distilling Neural Radiance Field to Neural Light Field for Efficient Novel View Synthesis</i>".<br>
    In <b>ECCV</b>, 2022.<br>
    <img src="https://raw.githubusercontent.com/mingsun-tse/mingsun-tse.github.io/master/images/project_icon.png" width="20" height="20" hspace="5">
...
<tr style="border-collapse: separate; border-spacing:none;">
  ...
  <td style="border-collapse: collapse; border: none;">
    ...
    "<i>Recent Advances on Neural Network Pruning at Initialization</i>".<br>
...
<tr style="border-collapse: separate; border-spacing:none;">
  ...
  <td style="border-collapse: collapse; border: none;">
    <b>Huan Wang*</b>, Yulun Zhang*, Can Qin, Yun Fu.<br>
    "<i>Aligned Structured Sparsity Learning for Efficient Image Super-Resolution</i>".<br>
...
<tr style="border-collapse: separate; border-spacing:none;">
  ...
  <td style="border-collapse: collapse; border: none;">
    ...
    "<i>Structured Pruning for Efficient ConvNets via Incremental Regularization</i>".<br>
...
<tr style="border-collapse: separate; border-spacing:none;">
  ...
  <td style="border-collapse: collapse; border: none;">
    ...
    "<i>Structured Probabilistic Pruning for Convolutional Neural Network Acceleration</i>".<br>
